...
INSERT INTO `categoriapizza` VALUES (1,'Petita'),(2,'Mitjana'),(3,'Gran'),(4,'Superior'),(5,'Supreme');
...
CREATE TABLE `empleat` (
  ...
  `ID_Botiga` int DEFAULT NULL,
  `TipusEmpleat` enum('PersonaldeBotiga','GerentBotiga','Cuiner','Repartidor') DEFAULT NULL,
  `Nom` varchar(45) DEFAULT NULL,
  `Cognoms` varchar(45) DEFAULT NULL,
...
INSERT INTO `empleat` VALUES (1,1,'PersonaldeBotiga','Javier','Miranda Vives','34675887E','674476632'),(2,1,'GerentBotiga','Jordi','Giralt Franc','43675476R','675887434'),(3,1,'Cuiner','Tomas','Sanchez Martinez','46757445A','756574463'),(4,1,'Repartidor','Toni','Setmenat Turró','37645647Y','668754733'),(5,1,'Repartidor','Miquel','Serrat Galdós','475665745F','678677867'),(6,2,'PersonaldeBotiga','Santi','Santillana Mir','12653465D','667785544'),(7,2,'PersonaldeBotiga','Marc','Sans Baró','276t64577A','644789435'),(8,2,'GerentBotiga','Ramon','Fernandez Pena','463766332K','714367587'),(9,2,'Cuiner','Merche','Ruiz Mesa','346856574F','678456767'),(10,2,'Repartidor','David','Rodriguez Perez','374576547D','666777444');
...
CREATE TABLE `producte` (
  ...
  `TipusProducte` enum('Pizza','Beguda','Hamburguesa') DEFAULT NULL,
...
INSERT INTO `producte` VALUES (1,'Pizza',1,'Pizza 4  formatges','Pizza cremosa i molt bona','pizza1.jpg',10),(2,'Pizza',2,'Pizza 4 estacions','Pizza cremosa i molt bona','pizza2.jpg',11),(3,'Pizza',3,'Pizza Barbacoa','Pizza cremosa i molt bona','pizza3.jpg',12),(4,'Beguda',NULL,'CocaCola Botella 2L','Beguda ensucrada de cola gran','cola1.jpg',3),(5,'Beguda',NULL,'CocaCola Llauna','Beguda ensucrada de col','cola2.jpg',4),(6,'Hamburguesa',NULL,'Hamburguesa Divina','Hamburguesa  deliciosa per lleparse els dits','burguer1.jpg',6),(7,'Hamburguesa',NULL,'Hamburguesa ExtraChilli','Hamburguesa molt picant','burguer2.jpg',8);
